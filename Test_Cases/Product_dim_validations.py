...
#C:\Users\MaNJu\PycharmProjects\ETL_Testing_Framework(Config Driven Framework)\Logs
#Calling Log_gen function from Utilities.
dt = datetime.now().strftime("%Y-%m-%d_%H-%M-%S")
logger = Logs.log_gen(f'C:\\Users\\MaNJu\\PycharmProjects\\ETL_Testing_Framework(Config Driven Framework))\\Logs\\product_dim_{dt}.log')

#C:\Users\MaNJu\PycharmProjects\ETL_Testing_Framework(Config Driven Framework)\Config\SQL_Queries_Config\Product_dim.json
with open(r'C:\Users\MaNJu\PycharmProjects\ETL_Testing_Framework(Config Driven Framework)\Config\SQL_Queries_Config\Product_dim.json','r') as Product_data_SQL_fle:
...
dt = datetime.now().strftime("%Y-%m-%d_%H-%M-%S")
#C:\Users\MaNJu\PycharmProjects\ETL_Testing_Framework(Config Driven Framework)\Output_Result
output_file_path = f"C:\\Users\\\MaNJu\\PycharmProjects\\ETL_Testing_Framework(Config Driven Framework)\\Output_Result\\Product_dim_Result_{dt}.xlsx"
